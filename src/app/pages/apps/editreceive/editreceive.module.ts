...
export class ReceiveModule {
 ...
 OrdDetail: [];
    // val: number;
    constructor(OrdId,OrderedById,SuppliedById,DispatchById,receivedById,finalarray,
        DispatchedDate,userId,createby,WipStatus,billId,billAmountNoTax,billAmount,
        taxAmount,receiveDate,OrdDetail) {
