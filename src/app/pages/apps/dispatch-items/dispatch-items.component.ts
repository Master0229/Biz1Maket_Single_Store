...
export class DispatchItemsComponent implements OnInit {
  ...
  selectedreceiveritem(item) {
    ...
    var finalarray;
    this.Disp = new DispatchModule(this.OrdId, this.OrderedById, this.SuppliedById, this.DispatchById, this.dispatchTypeId,
       finalarray, this.orderDate, this.users, this.createby,this.order.OrderDetail)
